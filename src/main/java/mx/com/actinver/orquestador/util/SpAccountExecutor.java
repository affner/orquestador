...
@Component
public class SpAccountExecutor {
    ...
    public SpAccountExecutor(@Qualifier("localDataSource") DataSource ds) {
                    ...
                    public RsDto<R> doInCallableStatement(CallableStatement c) throws SQLException {
                        ...
                        try (ResultSet rs = (ResultSet) c.getObject(3)) {
                            while (rs != null && rs.next()) {
                                ...
                                R accountEntity =  (R) AccountEntity.builder()
                                        .contractId(rs.getLong(1))
                                        .year(rs.getInt(2))
                                        .month(rs.getInt(3))
                                        .xsaInfo(rs.getString("FJXSAINFO"))
                                        .build();
                                rows.add(accountEntity);
