...
import mx.com.actinver.common.exception.InvalidTokenException;
		...
		if (requestTokenHeader != null && !requestTokenHeader.trim().isEmpty()) {
			if (requestTokenHeader.startsWith("Bearer ")) {
				...
				try {
					...
					throw new InvalidTokenException("No se puede obtener el token.");
				...
				throw new InvalidTokenException("El token debe iniciar con \"Bearer \"");
			}
		}
